<template>
    <div class="content">
      ...
      <div class="xinxi">
         ...
         <div class="menpai">
           <p>门牌号</p>
           <input type="text" placeholder="例：9号楼302室">
         </div>
         <div class="biaoqian">
           <p>标签</p>
           <div class="biaoqian1">
              <p class="biaoqian2" :class="{ a: changeGreen == index }" @click="green($event,index)" v-for="(item,index) of biaoqian" :key="index">{{item.label}}</p>
           </div>
         </div>
         <div class="moren">
           ...
           <div class="moren_right">
              <div :class="{ qiuti:ys1,qiuti1:ys2 }" @click="colorchange">
...
.sex1>p:nth-child(2),.sex2>p:nth-child(2){
  margin-left: 0.5rem;
  color: #1D1D1D;
  font-size: 1.6rem;
}
.sex1_1>span,.sex1_2>span{
  display: inline-block;
  width: 100%;
  height: 100%;
